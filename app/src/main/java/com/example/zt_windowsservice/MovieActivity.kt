...
import com.example.zt_windowsservice.widget.MovieView
import com.example.zt_windowsservice.databinding.MovieActivityBinding
...
class MovieActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun start(context: Context) {
            val starter = Intent(context, MovieActivity::class.java)
