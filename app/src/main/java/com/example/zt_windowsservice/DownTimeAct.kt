...
import com.example.zt_windowsservice.vm.MainViewModel
import com.example.zt_windowsservice.databinding.DownTimeActivityBinding
 ...
 */
class DownTimeAct : AppCompatActivity() {

    private val viewModel: MainViewModel by viewModels()
    private lateinit var binding: DownTimeActivityBinding
    ...
    companion object {
        ...
        fun start(context: Context) {
            val starter = Intent(context, DownTimeAct::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DownTimeActivityBinding.inflate(layoutInflater)
        ...
        binding.switchExample.setOnClickListener {
            startActivity(Intent(this@DownTimeAct, MovieActivity::class.java))
            finish()
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val intentFilter = IntentFilter().apply {
                addAction(ACTION_STOPWATCH_CONTROL)
            }
